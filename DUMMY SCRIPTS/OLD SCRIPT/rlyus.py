...
def main():
   ...
   return render_template('fish.html', **templateData, mainTankWaterLvl = var_mainTankWaterLvl)
...
def action(changePin, action):
   ...
   var_mainTankWaterLvl = measure()
   return render_template('fish.html',mainTankWaterLvl = var_mainTankWaterLvl ,**templateData)
